...
<div id="main" class="shell">
	<div id="content">
		<div class="post">
			...
			<br> Der Autor &uuml;bernimmt keinerlei Gew&auml;hr f&uuml;r die
			Aktualit&auml;t, Korrektheit, Vollst&auml;ndigkeit oder Qualit&auml;t
			der bereitgestellten Informationen. Haftungsanspr&uuml;che gegen den
			...
			unverbindlich. Der Autor beh&auml;lt es sich ausdr&uuml;cklich vor,
			Teile der Seiten oder das gesamte Angebot ohne gesonderte
			Ank&uuml;ndigung zu ver&auml;ndern, zu erg&auml;nzen, zu l&ouml;schen
			oder die Ver&ouml;ffentlichung zeitweise oder endg&uuml;ltig
			einzustellen. <br>
			<br>
			<h4>2.Verweise und Links</h4>
			<br> Bei direkten oder indirekten Verweisen auf fremde Webseiten
			...
			Urheberschaft der gelinkten/verkn&uuml;pften Seiten hat der Autor
			keinerlei Einfluss. Deshalb distanziert er sich hiermit
			ausdr&uuml;cklich von allen Inhalten aller gelinkten
			...
			<br> Der Autor ist bestrebt, in allen Publikationen die
			...
			<br> Dieser Haftungsausschluss ist als Teil des
